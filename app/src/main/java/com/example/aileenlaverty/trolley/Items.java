...
public class Items {
    ...
    public Items(){
        ...
        list.add(new Item("Cheese & Ham Panini", 4.00, ItemType.HOT_FOOD, 10));
        list.add(new Item("Pepperoni Mini Pizza", 4.00, ItemType.HOT_FOOD, 10));
        list.add(new Item("Cheese & Ham croissant", 3.50, ItemType.HOT_FOOD, 10));
    }
